...
public interface ApplicationRepo extends JpaRepository<JobApplication,Integer> {
    List<JobApplication> findByCompanyContainingOrJobDescContaining(String key,String key2);
}
